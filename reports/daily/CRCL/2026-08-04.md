...
- Generated: 2026-08-04T23:31:40.736731+00:00
- Latest daily market bar: 2026-08-04
- Explicit data refresh: successful
- Scope: technical analysis only; latest daily bars are not tick-level real-time quotes.

## 1. Stock overview

Price is **63.25**, versus a 2026-02-03–2026-08-04 range of 49.90–140.00. It is -54.82% from the period high and 26.75% from the period low.

## 2. Trend analysis

- SMA20 / SMA50 / SMA200: 63.76 / 75.56 / 88.96.
- Price position: SMA20 **below**, SMA50 **below**, SMA200 **below**.
- EMA20 / EMA50: 65.10 / 74.13; stack **bearish**.
- Latest SMA50/200 event: death_cross (2026-06-30).

## 3. Momentum

- RSI(14): **44.96** (neutral); divergence **bullish**.
- MACD / signal / histogram: -3.3841 / -4.1473 / 0.7632.
- MACD state: **bullish**, histogram **contracting**.

## 4. Volatility

- Bollinger lower / mid / upper: 58.84 / 63.76 / 68.69; %B 0.448.
- Squeeze: **True**; volatility **contracting**.
- ATR(14): 5.1885 (8.20% of price); expected daily range 5.19.
...
- Distance to support / resistance: 8.55% / 121.34%; range reward:risk 14.19.

**Confirmed supports**

- 59.97 (4 touches; last 2026-07-24; -5.19% from price)
- 55.31 (1 touches; last 2026-02-12; -12.55% from price)
- 49.90 (1 touches; last 2026-02-05; -21.11% from price)

**Confirmed resistances**

- 64.92 (1 touches; last 2025-11-20; 2.64% from price)
- 76.08 (8 touches; last 2026-07-21; 20.28% from price)
- 84.44 (2 touches; last 2026-04-09; 33.50% from price)

Dominant swing: **down**, 189.92 (2025-08-12) to 49.90 (2026-02-05). Nearest Fibonacci level is 0.236 at 82.94 (31.13% from price).
...
Compared with **4** prior report(s) from 2026-07-29 through 2026-08-04, price changed **3.08%**. RSI ranged from 40.86 to 44.96. Council state changed 0 time(s).
...
Archived-signal scorecard: **insufficient sample**. At a 5-bar horizon, 0 directional report(s) have matured, 0 are pending, and 5 were honest abstentions.
